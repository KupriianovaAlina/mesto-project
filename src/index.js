...
// Уважаемый Владислав, добрый день! Не могу понять, почему у вас не отображает фото-заглушка при битой ссылке
// У меня проект выглядит так: http://joxi.ru/52adxMXU0kXNqm